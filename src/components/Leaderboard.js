                                            ...
                                            <div className='card-body'>
                                                <div className='container'>
                                                    <div className='row justify-content-center'>
                                                        ...
                                                        <div className='col-sm-5 border-right flex-center-v'>
                                                            <p className='m-30-top margin-bot-none'><strong><span
                                                                className='p-5-right'>Answered Questions:</span></strong>
                                                                <span
                                                                    className='badge badge-secondary'>{user.questionsAnswered}</span>
                                                                </p>
                                                            <p className='margin-bot-none'><span className='p-5-right'><strong>Created Questions:</strong></span>
                                                                <span
